...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-surface-gray flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-[35%] h-[35%] bg-success-green/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="relative w-full max-w-md">
        <div className="relative z-10 bg-white border border-slate-200/80 rounded-3xl p-8 shadow-2xl">
          <div className="flex flex-col items-center mb-8 border-b border-slate-100 pb-6">
            ...
            <p className="text-slate-500 text-sm mt-2 font-medium">Masuk ke akun Anda</p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-slate-500 font-medium">
            Belum punya akun?{" "}
            <Link href="/register" className="text-primary hover:text-secondary font-black transition-colors">
              Daftar
            </Link>
          </p>
        </div>
